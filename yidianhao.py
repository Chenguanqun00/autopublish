...
def login(url, username, password):
    ...
    time.sleep(2)
    # frame = driver.find_element_by_name("//div[@class='ptlogin-container']/iframe")
...
if __name__ == '__main__':
    ...
    gifpath = r"C:\ziyuan\gif"                  #GIF资源路径
    gifnewpath = r"C:\自媒体\已发表\GIF\{0}\{1}".format(time.strftime("%Y%m%d", time.localtime()), "一点号")    #新GIF存放路径
    jpgpath = r"C:\ziyuan\pic"                  #pic资源路径
    jpgnewpath = r"C:\自媒体\已发表\pic\{0}\{1}".format(time.strftime("%Y%m%d", time.localtime()), "一点号")    #新pic存放路径
    ...
    # time.sleep(1)
    # driver.find_element_by_xpath('//*[@id="writting-box"]/div[2]/div[2]/div/div[1]/div[1]/div[1]/div[2]/div').click()
    # time.sleep(1)
    # driver.find_element_by_xpath('//*[@id="writting-box"]/div[2]/div[2]/div/div[1]/div[1]/div[2]/div/div[31]').click()
    # #点击上传图片
    time.sleep(4)
    driver.find_element_by_xpath('//*[@id="writting-box"]/div[2]/div[2]/div/div[4]').click()

    # frame = driver.find_element_by_id("upload_iframe")
    # driver.switch_to.frame(frame)
